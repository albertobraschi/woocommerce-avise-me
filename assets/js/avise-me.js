jQuery(document).ready(function() {
	...
	jQuery('#avisa').submit(function(event) {
		...
		jQuery.ajax({
			...
			url 		: '/wp-content/plugins/woocommerce-avise-me/avise-me.php', // the url where we want to POST
			...
			.done(function(data) {
				...
				if ( ! data.success) {
					...
					jQuery('form').append('<div class="alert alert-success">' + data.message + '</div>');
